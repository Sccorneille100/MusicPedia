      ...
      <div className='vertical-navbar__inner'>
        ...
        <div>
          ...
          >
            <Link to='/' className='vertical-navbar__link'>
              ...
              <p className='vertical-navbar__link--text'>{('homepage')}</p>
            </Link>
          </div>
          {/* SEARCH */}
          <div
          ...
          >
            <Link to='/search' className='vertical-navbar__link'>
              ...
              <p className='vertical-navbar__link--text'>{('search')}</p>
            </Link>
          </div>
          {/* COLLECTIONS */}
          <div
          ...
          >
            <Link to='/collection/playlists' className='vertical-navbar__link'>
              ...
              <p className='vertical-navbar__link--text'>{('library')}</p>
            </Link>
          </div>
        </div>
        {/* NAVBAR MIDDLE */}
        <div className='vertical-navbar__middle'>
          ...
          <div className='vertical-navbar__item'>
            ...
            <p className='vertical-navbar__link--text'>{('playlist')}</p>
          </div>
{/* FAVORITES */}
          <div className='vertical-navbar__item'>
            <span>
          ...
          <div className='vertical-navbar__item'>
            ...
            <p className='vertical-navbar__link--text'>{('episodes')}</p>
          </div>
          ...
          <p className='vertical-navbar__link--text'>{('download')}</p>
        </div>
      </div>
    </div>
  )
